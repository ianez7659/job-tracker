export default function AdminUsersLoading() {
  return (
    <div className="space-y-4">
      ...
      <div className="h-7 w-36 animate-pulse rounded-md bg-gray-200 dark:bg-gray-800" />
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <div className="h-7 w-28 animate-pulse rounded-md bg-gray-200 dark:bg-gray-800" />
        <div className="h-7 w-28 animate-pulse rounded-md bg-gray-200 dark:bg-gray-800" />
        <div className="ml-auto h-4 w-32 animate-pulse rounded bg-gray-200 dark:bg-gray-800" />
      </div>
      ...
      <div className="overflow-hidden rounded-xl border border-gray-200 dark:border-gray-800">
        ...
        <div className="border-b border-gray-200 bg-gray-50 px-4 py-3 dark:border-gray-800 dark:bg-gray-900">
          <div className="flex gap-4">
            {[140, 80, 60, 50, 50, 50, 70, 60, 60, 60, 40, 60, 90, 70, 80, 50].map((w, i) => (
              <div key={i} className={`h-3 w-[${w}px] animate-pulse rounded bg-gray-200 dark:bg-gray-700`} style={{ width: w }} />
            ))}
          </div>
        </div>
        ...
        {Array.from({ length: 10 }).map((_, i) => (
          ...
          >
            ...
            {[80, 60, 50, 50, 50, 70, 60, 60, 60, 40, 60, 90, 70, 80, 50].map((w, j) => (
