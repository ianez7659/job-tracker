      ...
      {hasMore && (
        ...
        >
          <motion.button
            ...
            className="px-5 py-2.5 rounded-lg border border-indigo-500 dark:border-yellow-500 text-indigo-600 dark:text-yellow-400 dark:hover:text-yellow-200 dark:hover:bg-yellow-900 hover:bg-indigo-50 font-medium transition-colors"
          >
